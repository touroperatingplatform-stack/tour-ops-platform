  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-hidden bg-white border-8 border-transparent">
        <div className="h-full overflow-auto px-4 py-3 border-8 border-transparent">
          ...
          {/* Company Settings */}
          <div className="mb-4">
            <h2 className="text-gray-500 text-xs font-semibold uppercase mb-2">{t('settings.company')}</h2>
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div className="px-4 py-3 border-b">
                <label className="text-xs text-gray-500 uppercase">{t('settings.companyName')}</label>
                <input
                  type="text"
              ...
              <div className="px-4 py-3 border-b">
                <label className="text-xs text-gray-500 uppercase">{t('settings.timezone')}</label>
                <select
              ...
              <div className="px-4 py-3 border-b">
                <label className="text-xs text-gray-500 uppercase">{t('settings.currency')}</label>
                <select
              ...
              <div className="px-4 py-3">
                <label className="text-xs text-gray-500 uppercase">{t('settings.language')}</label>
                <select
          ...
          {/* Preferences */}
          <div className="mb-4">
            <h2 className="text-gray-500 text-xs font-semibold uppercase mb-2">{t('settings.preferences')}</h2>
            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
              <div className="px-4 py-3 border-b flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500 text-xs">{t('settings.notificationsDesc')}</div>
                  </div>
                </div>
                <button
              ...
              <div className="px-4 py-3 border-b flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="text-xl">🤖</span>
                  <div>
                    <div className="font-medium">{t('settings.autoDispatch')}</div>
                    <div className="text-gray-500 text-xs">{t('settings.autoDispatchDesc')}</div>
                  </div>
                </div>
                <button
              ...
              <div className="px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <span className="text-xl">✓</span>
                  <div>
                    <div className="font-medium">{t('settings.requireChecklist')}</div>
                    <div className="text-gray-500 text-xs">{t('settings.requireChecklistDesc')}</div>
                  </div>
                </div>
                <button
