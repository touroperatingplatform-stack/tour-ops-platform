      ...
      <header className="bg-white flex-shrink-0">
        <div className="px-4 py-3 border-8 border-transparent">
          <div className="px-4 py-3">
            ...
            <h1 className="text-xl font-bold">{t('expenses.addNew')}</h1>
            <p className="text-gray-500 text-sm">{t('expenses.recordCost')}</p>
          </div>
        </div>
      </header>
          ...
          <div className="max-w-md mx-auto space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder={t('expenses.relatedTourPlaceholder')}
              />
            </div>
