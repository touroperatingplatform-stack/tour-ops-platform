      ...
      <div className="h-full flex flex-col gap-6 px-10 py-6">
        ...
        <div className="flex-none">
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-5 text-center">
              <p className="text-3xl font-bold text-blue-600">{stats.guestsToday}</p>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-5 text-center">
              <p className="text-3xl font-bold text-red-600">{stats.incidentsOpen}</p>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-5">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="text-center">
                      <p className="text-2xl font-bold">{stats.guidesActive}/{stats.guidesTotal}</p>
            ...
            <div className="col-span-3 h-full overflow-auto bg-white rounded-lg border border-gray-200 p-5 flex flex-col">
              ...
              <div className="flex-1 grid grid-cols-2 gap-4">
                <Link 
                  ...
                  className="flex flex-col items-center justify-center p-4 bg-blue-50 hover:bg-blue-100 rounded-lg transition-colors h-full"
                >
                ...
                <Link 
                  ...
                  className="flex flex-col items-center justify-center p-4 bg-green-50 hover:bg-green-100 rounded-lg transition-colors h-full"
                >
                  <span className="text-2xl mb-2">👤</span>
                ...
                <Link 
                  href="/admin/reports" 
                  className="flex flex-col items-center justify-center p-4 bg-purple-50 hover:bg-purple-100 rounded-lg transition-colors h-full"
                >
                  <span className="text-2xl mb-2">📊</span>
                ...
                <Link 
                  href="/admin/vehicles" 
                  className="flex flex-col items-center justify-center p-4 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors h-full"
                >
                  <span className="text-2xl mb-2">🚗</span>
