...
export default function GuideTestPage() {
  ...
  return (
    <div className="h-full border-8 border-transparent p-4">
      <div className="h-full border-8 border-transparent space-y-6">
        ...
        {/* Empty State */}
        {todayTours.length === 0 && (
          <div className="border-8 border-transparent bg-white rounded-2xl p-8 text-center border border-gray-200 shadow-sm">
          ...
          <div className="border-8 border-transparent">
            ...
            <div className="border-8 border-transparent grid grid-cols-2 gap-4">
              <Link 
                ...
                className="block bg-white rounded-2xl p-5 text-center hover:bg-gray-50 transition-colors border border-gray-200"
              >
