...
export default function CheckinPage() {
  ...
  async function loadData() {
    ...
    if (!tourData.acknowledged_at) {
      router.push(`/driver/tours/${tourId}/acknowledge`)
      return
    }
      ...
      return (
        <DriverNav>
          <div className="p-4">
            {/* Header */}
            <div className="mb-4">
              <Link href={`/driver/tours/${tourId}`} className="text-sm text-gray-500 mb-2 block">
                ← Back to Tour
              </Link>
    ...
    return (
      <DriverNav>
        <div className="p-4">
          {/* Header */}
          <div className="mb-4">
            <Link href="/driver" className="text-sm text-gray-500 mb-2 block">
              ← Back to Tours
            </Link>
