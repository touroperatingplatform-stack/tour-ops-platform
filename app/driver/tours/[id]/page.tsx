          ...
          <>
              ...
              <div className="bg-white rounded-2xl border border-orange-200 p-6 mb-4">
                ...
                <div className="bg-orange-50 rounded-xl p-4 border border-orange-200">
                  <div className="flex items-center justify-between">
                    ...
                    <Link
                      href={`/driver/tours/${tour.id}/checkin?type=pre_pickup&stopId=${pickupStops[0]?.id}`}
            ...
            {currentPhase === 'pickups' ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h2 className="font-semibold text-gray-900 text-lg">{t('guideTour.activities')}</h2>
                      ...
                      <div key={stop.id} className={`p-4 rounded-xl border-2 ${
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {isComplete ? (
                            ...
                            <Link
                              href={`/driver/tours/${tour.id}/checkin?type=activity&stopId=${stop.id}`}
                              className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700"
                            >
                              {pending > 0 ? `${pending} ${t('guideTour.pending')}` : t('guideTour.checkIn')}
                            </Link>
            ...
            {currentPhase === 'activities' ? (
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6">
                <div className="flex items-center gap-3 mb-4">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                    currentPhase === 'dropoffs' ? 'bg-blue-100' : 'bg-green-100'
                  }`}>
                    <span className={`font-bold ${currentPhase === 'dropoffs' ? 'text-blue-600' : 'text-green-600'}`}>
                      {currentPhase === 'dropoffs' ? '3' : '✓'}
                    </span>
                  </div>
                  <div>
                    <h2 className="font-semibold text-gray-900 text-lg">{t('guideTour.dropoffs')}</h2>
                      ...
                      <div key={stop.id} className={`p-4 rounded-xl border-2 ${
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {isComplete ? (
                            ...
                            <Link
                              href={`/driver/tours/${tour.id}/checkin?type=dropoff&stopId=${stop.id}`}
                              className="px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700"
                            >
                              {pending > 0 ? `${pending} ${t('guideTour.pending')}` : t('guideTour.checkIn')}
                            </Link>
