...
function DropoffCheckinContent() {
  ...
  return (
    <div className="p-4 space-y-4 max-w-md mx-auto">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-gray-500">Drop-off Check-in</span>
      </div>

      <div className="bg-white rounded-xl shadow p-4">
        <h1 className="text-xl font-bold mb-1">{tour.name}</h1>
        <p className="text-gray-500 text-sm">Drop-off Locations</p>
      </div>
      ...
      <div className="space-y-3">
        {stops.map((stop, idx) => (
          <div key={stop.id} className="bg-white rounded-xl shadow p-4">
            <div className="flex items-start justify-between mb-2">
              <div>
                <div className="text-xs text-gray-500 uppercase">Drop-off {idx + 1}</div>
        ...
        {stops.length === 0 && (
          <div className="text-center py-8 text-gray-500">
            No drop-off stops for this tour
          </div>
        )}
      </div>
    </div>
