        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          <div className="h-full grid grid-cols-12 gap-6">
            ...
            <div className="col-span-3 h-full overflow-auto">
              <div className="bg-white rounded-xl border border-gray-200 p-6 h-full flex flex-col">
                <div>
                  <span className="font-semibold text-sm text-center block mb-4">Quick Actions</span>
                </div>
                <div className="flex-1 grid grid-cols-2 gap-4 content-start">
                  <button className="flex flex-col items-center justify-center p-4 bg-blue-50 hover:bg-blue-100 rounded-xl transition-colors h-full">
                    <span className="text-2xl mb-2">➕</span>
                    <span className="text-xs font-medium">New Tour</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-4 bg-green-50 hover:bg-green-100 rounded-xl transition-colors h-full">
                    <span className="text-2xl mb-2">👤</span>
                    <span className="text-xs font-medium">Add User</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-4 bg-purple-50 hover:bg-purple-100 rounded-xl transition-colors h-full">
                    <span className="text-2xl mb-2">📊</span>
                    <span className="text-xs font-medium">Reports</span>
                  </button>
                  <button className="flex flex-col items-center justify-center p-4 bg-orange-50 hover:bg-orange-100 rounded-xl transition-colors h-full">
                    <span className="text-2xl mb-2">🚐</span>
