        ...
        <div className="flex-1 min-h-0 overflow-hidden">
          <div className="h-full grid grid-cols-12 gap-6">
            ...
            <div className="col-span-4 h-full overflow-auto">
              <div className="border-8 border-transparent h-full bg-white rounded-lg border border-gray-200 p-5">
            ...
            <div className="col-span-5 h-full overflow-auto">
              <div className="border-8 border-transparent h-full bg-white rounded-lg border border-gray-200 p-5 flex flex-col">
