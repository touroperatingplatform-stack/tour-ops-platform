      ...
      <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 py-6">
          ...
          <div className="border border-gray-200 rounded-lg bg-white p-4 mb-6">
            <div className="flex justify-between items-center">
              <h1 className="text-2xl font-bold text-gray-900 px-2">{t('regionalData.title') || 'Regional Data'}</h1>
              <button
          ...
          {/* Regions List */}
          <div className="border border-gray-200 rounded-lg bg-white p-4 mb-6">
            <h2 className="text-lg font-semibold text-gray-900 px-2 py-3 border-b border-gray-100">
            ...
            {loading ? (
              ...
              <p className="text-gray-500 p-4">No regions yet</p>
            ) : (
              <div className="divide-y divide-gray-100">
                {regions.map(region => (
                  <div key={region.id} className="p-4 hover:bg-gray-50">
        ...
        {showAddRegion && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="border border-gray-200 rounded-lg bg-white w-full max-w-md shadow-xl">
        ...
        {showImport && selectedRegion && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="border border-gray-200 rounded-lg bg-white w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-xl flex flex-col">
              <div className="p-4 border-b border-gray-100">
                <h2 className="text-lg font-bold text-gray-900">
              ...
              <div className="p-4 flex-1 overflow-y-auto">
                ...
                {/* Import Results */}
                {importResult && (
                  <div className={`p-4 rounded-lg border mb-4 ${importResult.errors.length > 0 ? 'bg-yellow-50 border-yellow-200' : 'bg-green-50 border-green-200'}`}>
