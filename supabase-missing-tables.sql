-- Tour Ops Platform - Create Missing Tables Only
...
DROP POLICY IF EXISTS "Users can view incidents they reported" ON incidents;
...
DROP POLICY IF EXISTS "Admins can update/delete expenses" ON expenses;
